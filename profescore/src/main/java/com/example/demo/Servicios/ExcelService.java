...
import com.example.demo.Entidades.Calificacion;import com.example.demo.Entidades.Profesor;
    ...
    public String processExcel(MultipartFile file) {
        try (InputStream is = file.getInputStream()) {
            ...
            while (rows.hasNext()) {
                ...
                calificacion.setNota_estudiante(notaEstudiante);
                calificacion.setNota_director(notaDirector);
                calificacion.setNota_autoevaluacion(autoevaluacion);
                calificacion.setNota_definitiva(definitiva);
